...
class WebsocketClient extends EventEmitter {
  constructor(
    ...
    if (websocketURI && typeof websocketURI === 'object') {
      let options = websocketURI;
      websocketURI = options.websocketURI
        ? options.websocketURI
        : 'wss://ws-feed.gdax.com';
      auth = options.auth ? options.auth : null;
      heartbeat = options.heartbeat ? options.heartbeat : false;
      channels = options.channels ? options.channels : null;
    }
